...
function TaskItem({ color }) {
  return (
    ...
    >
      <div
        className={`task-inner flex gap-4 items-center bg-gradient-to-r from-slate-950/75 to-slate-900 to-80% hover:from-slate-950/60 hover:to-slate-900 hover:to-100% py-1 px-4 rounded-xl`}
      >
